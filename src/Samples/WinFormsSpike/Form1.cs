...
namespace WinFormsSpike
{
    public partial class Form1 : Form
    {
        ...
        private void ListNewsHeadlinesButtonClick(object sender, EventArgs e)
        {
            new Thread(() =>
            {
                var response = _ctx.News.ListNewsHeadlinesWithSource("dj",CategoryTextBox.Text, (int)MaxResultsNumericUpDown.Value);
                Invoke(() =>
                {
        ...
        void NewsHeadlinesGridViewSelectionChanged(object sender, EventArgs e)
        {
            ...
            _ctx.News.BeginGetNewsDetail("dj",item.StoryId.ToString(), r =>
            {
