...
namespace StreamingClient
{
    ...
    public class LightstreamerClient : IDisposable
    {
        ...
        public LightstreamerClient(string streamingUri, string userName, string sessionId)
        {
        ...
        /// </summary>
        public void TearDownListener<TDto>(IStreamingListener<TDto> listener) where TDto : class, new()
        {
            lock (_adapters)
            {
