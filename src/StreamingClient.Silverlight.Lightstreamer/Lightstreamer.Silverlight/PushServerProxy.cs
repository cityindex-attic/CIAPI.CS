namespace Lightstreamer.DotNet.Client
{
    ...
    internal class PushServerProxy
    {
        ...
        internal virtual void DisposeStreams(Stream closingLowLevelStream, StreamReader closingStream, bool force)
        {
            ...
            if (force)
            {
                new AnonymousClassThread2(this.serverInfo, this).Start();
            }
        }
        ...
        internal virtual ServerUpdateEvent WaitUpdate(ServerManager.ActivityController activityController)
        {
            while (true)
            {
                this.Check();
        ...
        internal virtual SubscribedTableKey TableCode
        {
            get
            {
                ...
                {
                    currCode++;
                    return new SubscribedTableKey(currCode);
                }
            }
        }
