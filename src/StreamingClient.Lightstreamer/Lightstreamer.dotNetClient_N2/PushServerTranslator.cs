namespace Lightstreamer.DotNet.Client
{
    ...
    internal class PushServerTranslator
    {
        ...
        internal virtual Lightstreamer.DotNet.Client.ServerUpdateEvent ParsePushData(string pushData)
        {
            ...
            if (str2 == null)
            {
                Lightstreamer.DotNet.Client.ServerUpdateEvent event2 = new Lightstreamer.DotNet.Client.ServerUpdateEvent(tableCode, str);
            ...
            if (str2.Equals("EOS"))
            {
                return new Lightstreamer.DotNet.Client.ServerUpdateEvent(tableCode, str, true);
            }
            if (str2.StartsWith("OV"))
            {
                try
                {
                    return new Lightstreamer.DotNet.Client.ServerUpdateEvent(tableCode, str, int.Parse(str2.Substring("OV".Length)));
                }
                catch (Exception)
                {
                    throw new PushServerException(5, pushData);
