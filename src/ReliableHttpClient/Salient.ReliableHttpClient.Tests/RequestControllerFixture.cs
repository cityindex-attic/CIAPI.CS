...
namespace Salient.ReliableHttpClient.Tests
{
    ...
    public class RequestControllerFixture : LoggingFixtureBase
    {
        ...
        public void TestGet()
        {
            ...
            controller.BeginRequest(new Uri("http://api.geonames.org/citiesJSON?north=44.1&south=-9.9&east=-22.4&west=55.2&lang=de&username=demo"), RequestMethod.GET, null, null, ContentType.TEXT, ContentType.TEXT, TimeSpan.FromSeconds(1), 3000, "http://api.geonames.org", "citiesJSON?north=44.1&south=-9.9&east=-22.4&west=55.2&lang=de&username=demo", 0, null, ar =>
                                                                                                 {
                                                                                                     try
                                                                                                     {
        ...
        public void TestRecorder()
        {
            ...
            var requests = controller.Recorder.GetRequests();
