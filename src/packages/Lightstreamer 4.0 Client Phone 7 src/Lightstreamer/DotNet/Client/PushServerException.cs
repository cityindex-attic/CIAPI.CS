namespace Lightstreamer.DotNet.Client
{
    ...
    {
        private static readonly string[] defaultMsgs = new string[] { "Unspecified error", "Wrong table number", "Wrong item number", "Wrong number of fields", "Answer was interrupted", "Incorrect answer", "No answer", "Unexpected answer", "Session not found", "Server refusal", "No data from server", "No more answer from server", "Unexpected error", "Wrong message sequence or progressive number" };
