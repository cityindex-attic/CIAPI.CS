#  CIAPI.CS![Unsupported](http://labs.cityindex.com/wp-content/uploads/2012/01/lbl-unsupported.png)

#NB - this project is no longer being supported by City Index Ltd.
